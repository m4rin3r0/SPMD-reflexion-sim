...
"""Table of content
positive tests:
    C1: Verlustfreie Leitung: reelles Z₀
    C2: Hochfrequenz-Grenzwert
    C3: Viertelwellenlängen-Verhalten
    C4: Kurze Leitung = konzentrierte L
    C5: Symmetrie Y₁₁ = Y₂₂
    C6: Reziprozität Y₁₂ = Y₂₁
    C7: Passivität Re(Z_in) ≥ 0
    C8: FormShape und Dtype
negative tests:
    C9-C12: Validierung
"""
